...
$(document).ready(function(){
  ...
  $(".notice_title").on("click",function(){
    location.href = "/main/notice_detail?idx="+$(this).attr("idx");
  });
...
<div id="china_gongzi">
  <div class="gongzi_ma">
    <h1 class="gong_txt">공지사항</h1>
    <h3 class="gong_txt2 web">렛츠고 차이나 고객센터에서 알려드립니다.</h3>
  </div>
</div>
<div class="list">
  <div class="search">
  ...
  <table id="gong_list" class="web">
    ...
    <tr>
      ...
      <td class="notice_title ls_on" idx="<?=$list[$i]['idx']?>">
        <span class="li_ont">
          <?=$list[$i]['title']?>
        </span>
      </td>
  ...
  <div id="gong_list" class="mobile">
    <ul>
      ...
      ?>
      <li>
        <p class="notice_title" idx="<?=$list[$i]['idx']?>"><?=$list[$i]['title']?></p>
